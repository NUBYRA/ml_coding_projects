...
def perform_eda(df):
    ...
    output:
            Missing counts by column: (.png) saved in "./images/eda/..." folder
            Descriptive statistics per column: (.png) saved in "./images/eda/..." folder
    '''
    ...
    ## descriptive stats saved as image
